  ...
  async fetch(request, env, ctx) {
    ...
    try {
      ...
      if (path === "/api/avatar/upload" && request.method === "POST") {
        ...
        const avatarUrl = `https://pub-${env.STORAGE}.r2.dev/${fileName}`;
        await db.execute(
...
// .wrangler/tmp/bundle-YFdwrZ/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-YFdwrZ/middleware-loader.entry.ts
