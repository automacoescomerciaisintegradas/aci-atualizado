...
var PasswordResetService = class {
  ...
  async sendResetEmail(to, name, resetUrl, code) {
    ...
    console.log("========================================");
    console.log(`\u{1F4E7} Email: ${to}`);
    console.log(`\u{1F464} Nome: ${name}`);
    ...
    try {
      ...
      console.log("\u{1F4A1} Use o link acima para testar o reset de senha localmente");
    }
  }
  /**
  ...
  async sendViaMailChannels(to, subject, html, text) {
    const response = await fetch("https://api.mailchannels.net/tx/v1/send", {
      ...
      body: JSON.stringify({
        ...
        from: {
          email: this.emailConfig.SMTP_USERNAME,
...
// .wrangler/tmp/bundle-KjOffn/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-KjOffn/middleware-loader.entry.ts
