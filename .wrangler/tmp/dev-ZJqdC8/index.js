  ...
  async fetch(request, env, ctx) {
    ...
    try {
      ...
      if (path === "/api/integrations/instagram/auth" && request.method === "GET") {
        ...
        if (!appId) {
          return errorResponse("Facebook App ID n\xE3o configurado. Configure FACEBOOK_APP_ID no wrangler.toml", 500);
        }
        ...
        return jsonResponse({
          success: true,
          url: authUrl,
          message: "Redirecione o usu\xE1rio para esta URL"
        });
      }
      if (path === "/api/integrations/instagram/callback" && request.method === "POST") {
        ...
        return jsonResponse({
          success: true,
          message: "Callback recebido. Implementa\xE7\xE3o pendente."
        });
      }
      if (path === "/api/health") {
        return jsonResponse({
...
// .wrangler/tmp/bundle-YvxWDl/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-YvxWDl/middleware-loader.entry.ts
